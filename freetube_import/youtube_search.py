...
class YoutubeSearch:
    ...
    def _parse_html(self, response):
        ...
        if contents_list := data["contents"]["twoColumnSearchResultsRenderer"]["primaryContents"]["sectionListRenderer"]["contents"]:
            for contents in contents_list: # Check if anything is missing
